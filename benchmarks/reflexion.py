...
from search.strategies import BestFirstSearch
...
async def run_benchmark():
    ...
    print(
        f"Best-First: Score={best.score if best else 0}, Solved={'Solved' in str(best.metadata) if best else False}"
    )
